...
async function printReceiptFromDemoData (printerName) {
  ...
  doc.pipe(concat(function (data) {
    ...
    var msg = {
      "operation-attributes-tag": {
        "requesting-user-name": "DemoMaker",
        "job-name": "demoMaker.pdf",
...
module.exports.printReceiptFromDemoData = printReceiptFromDemoData
